...
const ChannelName = ({ onChannelClick, alertRooms , setAlertRooms, selectedSeq, newRooms, isOn }) => {

  const {
    rooms, chatSeq,
    handleClickChat
  } = useChannelName(onChannelClick, alertRooms , setAlertRooms, newRooms, isOn);
